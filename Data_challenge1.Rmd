...
plot_low10 <- ggplot(df_clean, aes(Race, Percent, fill = Race)) +
  ...
  coord_flip() +
  theme_bw() + 
  facet_geo(~ State ,grid = "us_state_grid1") + theme(text = element_text(size = 6)) 
...
print(plot_low10 + mynamestheme + labs( title = "Percent Distribution of Race Throughout Different States For Low Access Tract That is 10 Miles Away From Supermarket") ) + ggsave("ggplot_with_overlapping_axis_text_wide.png", width=12)
```
